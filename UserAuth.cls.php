 ...
 * UserAuth Class
 * ------------------------------------------------------------------------------
 * @copyright    Copyright (c) 2011, Auction.com, LLC
 * @version      $Revision: 196 $
 * @modifiedby   $LastChangedBy: colynb $
 * @lastmodified $LastChangedDate: 2011-08-18 11:56:56 -0700 (Thu, 18 Aug 2011) $
 * -----------------------------------------------------------------------------
 */

/**
 * UserAuth handles the current visitor states and processes
 */
class UserAuth {
